...
conformance: 95 comparisons over 2465 golden fixture records, each track against the golden
...
| gate | result |
|---|---|
| `python_pure` tests | 2751 passed |
| `python_cpp` tests | 414 passed |
| C++ tests (Catch2) | 109 passed |
