...
conformance: 90 comparisons over 2461 golden fixture records, each track against the golden
...
| gate | result |
|---|---|
| `python_pure` tests | 2737 passed |
| `python_cpp` tests | 407 passed |
| C++ tests (Catch2) | 100 passed |
| conformance | 90 comparisons, all tracks agree |
